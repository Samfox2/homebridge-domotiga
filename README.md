...
* "valueHumidity": Value no. of Domotiga device that represents the humidity (oprional for "TempHygroMeter")
* "valueContact":  Value no. of Domotiga device that represents the contact (required for "Contact")
* "valueSwitch":   Value no. of Domotiga device that represents the switch (required for "Switch")
* "valueBattery":  Value no. of Domotiga device that represents the battery (not yet supported by actual homekit)
