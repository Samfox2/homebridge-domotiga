...
* "valueTemperature": Which value no. represents the temperature (required for "TempHygroMeter")
* "valueHumidity": Which value no. represents the humidity (optional for "TempHygroMeter")
* "valueContact":  Which value no. represents the contact (required for "Contact")
* "valueSwitch":   Which value no. represents the switch (required for "Switch")
* "valueBattery":  Which value no. represents the battery (not yet supported by actual homekit apps)
